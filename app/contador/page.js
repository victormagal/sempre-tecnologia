      ...
      <Container newClasses="py-24">
        <div className="col-span-5">
          ...
          <ul className="flex space-x-4">
            <li>
              <Link href="https://www.facebook.com/sempretecnologia/">
                <FontAwesomeIcon
            ...
            <li>
              <Link href="https://www.linkedin.com/company/sempre-tecnologia/">
                <FontAwesomeIcon
                  className="h-6 text-custom-orange"
                  icon={faLinkedin}
                />
            ...
            <li>
              <Link href="https://www.instagram.com/sempretecnologia/">
                <FontAwesomeIcon
                  className="h-6 text-custom-orange"
                  icon={faInstagram}
                />
