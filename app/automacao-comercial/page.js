        ...
        <Container newClasses="py-24">
          ...
          <div className="col-span-5 flex flex-col justify-center">
            ...
            <p className="mt-6 text-soft-gray">
              ...
              muito mais, tudo de maneira simples para facilitar o funcionamento
              e gestão de sua empresa.
            </p>
          </div>
        </Container>
        <Container newClasses="pb-24">
          <h1 className="col-span-12 font-sans my-6 text-dark-blue text-3xl text-center">
            <span className="font-bold">Funcionalidades exclusivas</span> que
            são ideais para o seu negócio:
          </h1>
          <Card
        ...
        <BackgroundContainer uri="/bg-automacao.svg">
          ...
          <div className="col-span-5 flex flex-col justify-center">
            ...
            <p className="text-white mb-6">
              Adeque sua empresa às exigências da legislação vigente. O
              SemprePDV é de fácil utilização, cadastra clientes e produtos,
              emite cupons eletrônicos, gera relatórios de faturamento, vendas
              diárias e totais.
            </p>
            <button
