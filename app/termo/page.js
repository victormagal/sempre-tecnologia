      ...
      <Container>
        <div className="col-span-4 lg:col-span-8 lg:col-start-3 flex flex-col space-y-8">
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              Nós coletamos informações que você (usuário), fornece diretamente
              ao utilizar nosso site, como nome, endereço de e-mail e outras
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              armazenados pela plataforma tem por finalidade: personalizar sua
              experiência no site, processar transações, enviar informações
              relevantes, responder a perguntas e fornecer suporte. Também
              podemos utilizar as informações para melhorar nossos serviços,
              realizar análises internas e enviar comunicações de marketing,
              esta última somente nas hipóteses de autorização expressa quanto
              ao recebimento de conteúdo.
            </Text>
          </article>
          <article className="flex flex-col space-y-4">
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              para cumprir as finalidades para as quais foram coletadas. Após o
              período de retenção, suas informações serão devidamente
              anonimizadas ou excluídas de nossos sistemas.
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
              No mais, os dados pessoais dos usuários apenas podem ser
            ...
            <ul>
              ...
              <li>
                <Text appearance="p3" color={neutralMid[500]}>
                  2. Estudo por órgão de pesquisa, garantida, sempre que
                  possível, a anonimização dos dados pessoais;
                </Text>
              </li>
              <li>
                <Text appearance="p3" color={neutralMid[500]}>
                  3. Transferência a terceiro, desde que respeitados os
                  requisitos de tratamento de dados dispostos nesta Lei;
                </Text>
              </li>
              <li>
                <Text appearance="p3" color={neutralMid[500]}>
                  4. Uso exclusivo do controlador, vedado seu acesso por
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              ou alteração. No entanto, é importante lembrar que nenhum método
              de transmissão pela internet ou sistema de armazenamento
              eletrônico é totalmente seguro, assim, em caso de qualquer falha
              ou invasão, agiremos tomando todas as medidas necessárias para
              compelir quaisquer atos decorrentes da falibilidade.
            </Text>
          </article>
          <article className="flex flex-col space-y-4">
            <Title appearance="h3" color={neutralDark[500]} extra>
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              <strong>Retificação dos Dados:</strong> Caso o usuário acredite
              que os dados pessoais que possuímos estão incorretos ou
              desatualizados, pode solicitar a correção ou atualização.
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              <strong>Revogação do Consentimento:</strong> Se tivermos coletado
              e processado dados pessoais com base no consentimento do usuário,
              este terá o direito de revogar seu consentimento a qualquer
              momento.
            </Text>
          </article>
          <article className="flex flex-col space-y-4">
