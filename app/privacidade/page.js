    ...
    <main className="pt-24">
      ...
      <Container>
        <div className="col-span-4 lg:col-span-8 lg:col-start-3 flex flex-col space-y-8">
          <article className="flex flex-col space-y-4"></article>
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              outras informações de contato que você forneça voluntariamente
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              2.5. Dados Sensíveis: A plataforma poderá coletar os seguintes
              dados sensíveis do usuário, como: origem étnica ou racial, opinião
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              informações sobre interação e acesso são coletadas pela empresa
              para garantir uma melhor experiência ao usuário e visitante. Estes
              dados podem tratar sobre as palavras-chaves utilizadas em uma
              busca, o compartilhamento de um documento específico, comentários,
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              armazenados pela plataforma tem por finalidade:
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              além de facilitar, agilizar e cumprir os compromissos
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              atualizações, notificações e materiais promocionais, quando você
              nos dá seu consentimento para isso.
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              5.1. Conservaremos os dados pessoais coletados pelo tempo
              necessário para cumprir os propósitos descritos nesta Política de
              Privacidade, a menos que um período de retenção mais longo seja
              exigido ou permitido pela lei aplicável, conforme o disposto no
            ...
            <ul className="flex flex-col pl-8 space-y-4">
              <li>
                <Text appearance="p3" color={neutralMid[500]}>
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              transmissão dos dados entre o servidor e o usuário ocorre de
              maneira cifrada e encriptada.
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              7.1. Parceiros e Prestadores de Serviços: Podemos compartilhar
              dados pessoais com parceiros de negócios e prestadores de serviços
              terceirizados que nos auxiliam na operação do site, fornecimento
              de serviços, processamento de pagamentos, envio de comunicações ou
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              legais, proteger nossos direitos ou responder a solicitações
              legais válidas.
            </Text>
          </article>
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              armazenados, com informações relacionadas à navegação no site.
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              seus dados pessoais em determinadas circunstâncias, de acordo com
              a lei aplicável.
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              10.1. Ao utilizar os serviços e fornecer as informações pessoais
              na plataforma, o usuário está consentindo com a presente Política
              de Privacidade.
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              11.1. Reservamos o direito de modificar essa Política de
              Privacidade a qualquer momento. A versão mais recente estará
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              usuário e visitante demonstra sua concordância com as novas
              normas.
            </Text>
            <Text appearance="p3" color={neutralMid[500]}>
          ...
          <article className="flex flex-col space-y-4">
            ...
            <Text appearance="p3" color={neutralMid[500]}>
              ...
              uso indevido, alteração, destruição ou divulgação não autorizada.
            </Text>
          </article>
          <article className="flex flex-col space-y-4">
            <Title appearance="h4" color={neutralDark[500]} extra>
