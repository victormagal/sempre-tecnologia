...
import { neutralDark, neutralLight, red } from '@/app/base/Colors';
  ...
  return (
    <div>
      ...
      <Container newClasses="lg:hidden flex flex-col py-6">
        ...
        {isOpen && (
          <div className="fixed z-10 top-0 top-20 left-0 mt-2 bg-white text-gray-800 border rounded-lg shadow-lg h-screen w-screen overflow-scroll">
            <ul className="flex flex-col justify-stretch w-full px-4 py-4">
              ...
              <li className="relative p-4">
                <details className="group">
                  ...
                  <article className="pb-4">
                    <ul className="flex flex-col gap-4 mt-4 mb-42">
                      <li className="flex-1">
                        <ul>
                ...
                <details className="group">
                  ...
                  <article className="pb-4">
                    <ul className="flex flex-col gap-0 mt-4 mb-42">
                      ...
                      <li className="flex text-sm py-3 ml-11 mb-2">
                        <Text appearance="p4" color={neutralDark[500]}>
              ...
              <li className=" p-4 mb-2 group-open: mb-96">
                <Link href="/">
                  <Text appearance="p4" color={neutralDark[500]}>
                    Contato
                  </Text>
              ...
              <li className="fixed bottom-0 p-4 w-full left-0 p-6 border-t-2 bg-white">
                <button
