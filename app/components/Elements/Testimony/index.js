                ...
                <div className="inline-block">
                  <div className="bg-white flex flex-col h-80 w-108 justify-between p-8 rounded">
                    <p className="text-soft-gray">
                      ...
                      problemas com rapidez e eficiência. Indico todos os
                      clientes que conheço para a Sempre pela facilidade em
                      emitir nossas notas e atenção que temos na venda e
                      pós-venda.
                    </p>
                    <div className="flex mt-8">
                      <Image
                ...
                <div className="inline-block">
                  <div className="bg-white flex flex-col h-80 w-108 justify-between p-8 rounded">
                    <p className="text-soft-gray">
                      ...
                      agradecer a parceria da Sempre Tecnologia, que sempre me
                      atende e me ajuda a prestar um ótimo serviço ao meu
                      cliente final!
                    </p>
                    <div className="flex mt-8">
                      <Image
                ...
                <div className="inline-block">
                  <div className="bg-white flex flex-col h-80 w-108 justify-between p-8 rounded">
                    <p className="text-soft-gray">
                      ...
                      Distrito Federal. Parabéns Sempre Tecnologia.
                    </p>
                    <div className="flex mt-8">
                      <Image
                        alt="Sempre mensalidade"
                ...
                <div className="inline-block">
                  <div className="bg-white flex flex-col h-80 w-108 justify-between p-8 rounded">
                    <p className="text-soft-gray">
                      ...
                      solícitos para te ajudar e foi isso que encontrei na
                      Sempre Tecnologia
                    </p>
                    <div className="flex mt-8">
                      <Image
                ...
                <div className="inline-block">
                  <div className="bg-white flex flex-col h-80 w-108 justify-between p-8 rounded">
                    <p className="text-soft-gray">
                      ...
                      equipe é bem capacitada e preza pela excelência no
                      atendimento ao cliente. Organizada e eficiente nas
